...
public class ProductController {
	...
	@PostMapping
	public ResponseEntity<Product> createProduct(@RequestHeader("token") String token, @RequestBody Product product) throws PersistException, UnauthorizedException {
